...
// --- Icons ---
import { RiForbidLine, RiMarkPenLine } from "@remixicon/react";
  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        tooltip={t("toolbar.highlight.label")}
        ref={ref}
        {...props}
      >
        {children ?? <RiMarkPenLine className="tiptap-button-icon" />}
      </Button>
    );
  }
);
        ...
        <CardItemGroup orientation="horizontal">
          <ButtonGroup orientation="horizontal">
            {colors.map((color, index) => (
              <ColorHighlightButton
                ...
                tooltip={t(`toolbar.highlight.colors.${color.label}`)}
                aria-label={t(`toolbar.highlight.colors.${color.label}`)}
          ...
          <ButtonGroup orientation="horizontal">
            <Button
              ...
              aria-label={t("toolbar.highlight.remove")}
              tooltip={t("toolbar.highlight.remove")}
...
export function ColorHighlightPopover({
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent aria-label={t("toolbar.highlight.label")}>
