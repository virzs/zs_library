...
// --- Tiptap UI ---
import { headingIcons, type Level, isHeadingActive, canToggle, shouldShowButton } from "../heading-button";
...
export function useHeadingDropdownMenu(config?: UseHeadingDropdownMenuConfig) {
  ...
  return {
    ...
    levels,
    label: t("toolbar.heading.label"),
    Icon: activeLevel ? headingIcons[activeLevel] : RiHeading,
  };
}
