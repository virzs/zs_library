...
const ContextMenu = ({
  ...
  useEffect(() => {
    ...
    setRenderContextMenu(contextMenu);
  }, [contextMenu]);

  const activeContextMenu = contextMenu ?? renderContextMenu;
  const data = activeContextMenu?.data;
